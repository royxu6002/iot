                        ...
                        <div class="row">
                            ...
                            <div class="product-tabs align-items-center justify-content-between col-lg-5 col-md-12 col-sm-12">
                                    ...
                                    <ul class="nav" id="myTab" role="tablist">
                                      <li class="nav-item">
                                        <a class="nav-link active sub-nav-link" id="product-desc-tab" data-toggle="tab" href="#product_desc" role="tab" aria-controls="product_desc" aria-selected="true"><h4> {{ $product->product_name }} Description</h4></a>
                                      </li>
                                    </ul>
